...
printf 'VUE_APP_CLOUDWATCH_RUM_APP_MONITOR_ID=%s\n' "$CLOUDWATCH_RUM_APP_MONITOR_ID" >> .env
printf 'VUE_APP_CLOUDWATCH_RUM_GUEST_ROLE_ARN=%s\n' "$CLOUDWATCH_RUM_GUEST_ROLE_ARN" >> .env
printf 'VUE_APP_CLOUDWATCH_RUM_REGION=%s\n' "$DEPLOYED_REGION" >> .env
...
printf 'VUE_APP_FENIX_X_API_KEY=%s\n' "$FENIX_X_API_KEY" >> .env